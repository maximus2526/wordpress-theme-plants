...
use Elementor\Controls_Manager; // Додайте цей рядок для підключення класу Controls_Manager
use Elementor\Group_Control_Typography; // Додайте цей рядок для підключення класу Group_Control_Typography
use Elementor\Group_Control_Text_Shadow; // Додайте цей рядок для підключення класу Group_Control_Text_Shadow
use Elementor\Utils;


class Widget_Star_Rating_Plus extends Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Star Rating Custom', 'elementor-addon' );
	}
